    ...
    <section className="mx-7 md:mx-0">
      <div className="md:flex md:justify-between mt-10 mb-6">
        <ul className="grid grid-cols-3 gap-4">
          <li
            className="mx-2 md:w-[75%] place-self-start text-center text-grey hover:text-black hover:border-b-2 hover:border-black"
          ...
          <li
            className="mx-2 md:w-full place-self-center text-center text-grey hover:text-black hover:border-b-2 hover:border-black"
          ...
          <li
            className="mx-2 md:w-[100%] place-self-end md:place-self-start  text-center text-grey hover:text-black hover:border-b-2 hover:border-black"
